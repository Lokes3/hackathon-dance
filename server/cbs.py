...
from server.a_star_cbs import AStar
...
def pad_solution(solution):
    ...
    for agent in solution:
        ...
        padding = len_diff*[path_list[-1]]
        padded_solution[agent] = path_list + padding
    return padded_solution



def find_dance_path(agents, xmax, ymax):
    #parser = argparse.ArgumentParser()
    #parser.add_argument("param", help="input file containing map and obstacles")
    #arser.add_argument("output", help="output file with the schedule")
    ...
    env = Environment([xmax, ymax], agents, [])
